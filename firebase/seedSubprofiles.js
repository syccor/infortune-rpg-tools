...
// 1) Télécharge une clé de compte de service
// Firebase console > Project settings > Service accounts > Generate new private key
// 2) Place le fichier JSON dans: scripts/serviceAccountKey.json
...
const classProfiles = [
...

  {
    ...
    label: "Escrimeur",
    description: "Augmente le max d'esquive de 5 et le jet d'attaque de 5. Une esquive réussie augmente le prochain jet d’attaque de 5.",
    order: 1
  },

  {
    ...
    classId: "shooter",
    label: "Préparation",
    description: "Les échecs simples en attaque des tirs (2 à 9) n'infligent pas de dégâts au tireur. Augmente le jet d’attaque de 10 si le tireur ne s’est pas déplacé à ce tour.",
    order: 2
  },

  {
    ...
    classId: "light-fighter",
    label: "Vivacité",
    description: "Permet de se déplacer avant ou après avoir attaqué. Ne subit jamais de jets de repli.",
    order: 3
  },
...

  {
    ...
    classId: "all",
    label: "Détonation",
    description: "Augmente le transport de consommables de 1 et l’armure contre les dégâts de zone de 25 au-delà de la limite de 25.",
    order: 6
  },

  {
    ...
    label: "Résilience",
    description: "Augmente de 5 le jet de blocage au petit bouclier et de 10 au grand bouclier. Un blocage parfait augmente le prochain jet de blocage de 10.",
    order: 7
  },

  {
    ...
    classId: "heavy-fighter",
    label: "Brutalité",
    description: "Augmente le jet d’attaque au corps à corps de 5. Passe à 15 contre plus de deux ennemis avec arme lourde ou double arme.",
    order: 8
  },

  {
    ...
    classId: "heavy-fighter",
    label: "Combativité",
    description: "Au corps à corps : choisir +5 attaque ou +5 blocage. Gagne 4 PV si action au tour précédent.",
    order: 9
  },
...

  {
    ...
    classId: "demonist",
    label: "Démonologie",
    description: "Diminue le coût d'invocation des démons de 1 fragment et augmente leurs PV de 10.",
    order: 2
  },
